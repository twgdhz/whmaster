...
import com.whmaster.tl.whmaster.customview.SlidingButtonView;
                ...
                if (isGenerate) {
                    ...
                    HashMap<String, Object> map;
                        for (int i = 0; i < mList.size(); i++) {
                            ...
                            map.put("planNum", mList.get(i).get("planNum") + "");
                ...
                if (mWhareList != null && mWhareList.size() > 0) {
                    OptionsPickerView pvOptions = new OptionsPickerView.Builder(this, new OptionsPickerView.OnOptionsSelectListener() {
                        ...
                        public void onOptionsSelect(int options1, int options2, int options3, View v) {
                            ...
                            mWharehouseId = mKuList.get(options1).get("wharehouseId") + "";
...
//                        .isDialog(true)//是否显示为对话框样式
    ...
    public void onSuccess(String type, Object object) {
        switch (type) {
            case "map":
                mMap = (HashMap<String, Object>) object;
...
//                            }
    ...
    class RecyAdapter extends RecyclerView.Adapter<RecyAdapter.MyViewHolder> implements SlidingButtonView.IonSlidingButtonListener {
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int position) {
            ...
            holder.mProductNum.setText("货品数量：" + mList.get(position).get("planPackageNum"));
